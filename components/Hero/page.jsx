    ...
    <div className="relative w-full h-screen">
      ...
      <div className=" lg:hidden relative z-20 flex flex-col gap-5 items-start  pb-[15px] pt-[130px]">
        <a
          ...
          className="flex items-center ml-[50px] border-2 border-cool-green text-white bg-black px-[12px] py-[4px] rounded-full"
        >
        ...
        <a
          href="tel:+38119711"
          className="flex gap-[2px] ml-[100px] items-center border-2 border-cool-green text-white bg-black px-[12px] py-[4px] rounded-full tracking-tight"
        >
        ...
        <a
          ...
          className="flex gap-1 ml-[150px] items-center border-2 border-cool-green text-white bg-black px-[12px] py-[4px] rounded-full"
        >
