      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg text-gray-600 text-center mb-12">
            Cool Taxi Niš - prvi taxi koji stiže na poziv. Pouzdan partner za
            sve vaše putovanja. Brz, siguran i ekološki prevoz 24/7.
          </p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Cool Taxi Niš - prvi taxi koji stiže na poziv. Pouzdan taxi prevoz do svih destinacija. Brz, siguran i ekološki prevoz 24/7.",
