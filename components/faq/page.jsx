...
const FAQ = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "Da, Cool Taxi Niš radi 24 sata dnevno, 7 dana u nedelji. Možete nas pozvati u bilo koje doba dana i noći i uvek smo prvi taxi na adresi .",
    },
    {
      question: "Koji su brojevi za poziv Cool Taxi Niš?",
      answer:
        "Možete nas pozvati na sledeće brojeve: 19711, 065/97 197 11 (MTS), 069/197 11 11 (Yettel), 060/32 197 11 (A1) ili putem Viber aplikacije.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Da, Cool Taxi Niš vozi do svih aerodroma u regionu. Aerodrom Beograd, aerodrom Skoplje, aerodrom Sofija",
    },
    {
      question: "Koja vozila koristite?",
      answer:
        "Cool Taxi Niš koristi isključivo hibridna i električna vozila novije proizvodnje, što osigurava udobnu, tihu i ekološki odgovornu vožnju.",
    },
    {
      question: "Da li naplaćujete prtljag?",
      answer:
        "Ne, Cool Taxi Niš ne naplaćuje prtljag. Možete nositi svoj prtljag bez dodatnih troškova.",
    },
    {
      question: "Da li možete rezervisati vožnju unapred?",
      answer:
        "Da, možete rezervisati vožnju unapred pozivom ili putem naše mobilne aplikacije.",
    },
  ];
            ...
            <div key={index} className="mb-4">
              ...
              >
                <div className="flex justify-between items-center">
                  <p className="text-lg lg:text-xl font-semibold text-gray-900 pr-4">
                    {faq.question}
                  </p>
                  <span
                    className={`text-cool-green text-2xl transition-transform ${
