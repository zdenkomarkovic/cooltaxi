      ...
      <nav className="lg:hidden px-[5px] py-3 z-100 ">
        <div className="flex justify-between pb-[15px]">
          <a
            ...
            className="flex items-center border-2 border-cool-green text-cool-green bg-black px-[3px] h-[35px] rounded-full tracking-tight"
          >
            {" "}
          ...
          <a
            ...
            className="flex gap-1 items-center border-2 border-cool-green text-cool-green bg-black px-[3px] h-[35px] rounded-full tracking-tight"
          >
            {" "}
